...
const certifications = [
  {
    ...
    date: 'November 2025',
    description:
      'Successfully completed Introduction to Agile Development and Scrum, covering Backlogs,Team Management,Sprint Retrospectives,Continuous Improvement Process,Performance Measurement,User Story,Kanban Principles,Agile Project Management,Sprint Planning,Workflow Management,Agile Software Development,Team Building',
  ...
  },
  {
    ...
    date: 'November 2025',
    description:
      'Successfully completed Introduction to DevOps, covering Performance Metrics,Cross-Functional Collaboration,Culture Transformation,Scrum (Software Development),Cloud-Native Computing,Devops,Behavior-Driven Development,CI/CD,Test Driven Development (TDD),Accountability,Agile Methodology and Microservices',
